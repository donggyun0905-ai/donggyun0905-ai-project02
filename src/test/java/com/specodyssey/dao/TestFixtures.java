...
final class TestFixtures {
    ...
    static long insertSkill(Connection conn, String skillName) throws SQLException {
    ...
    static void hardDelete(Connection conn, String table, long id) throws SQLException {
    ...
    static void hardDeleteByColumn(Connection conn, String table, String column, long value) throws SQLException {
